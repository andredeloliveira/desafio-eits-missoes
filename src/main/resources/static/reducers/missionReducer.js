/**
  Reflects all the functions declared in the missionActions
  @see /actions/missionActions.js
...
export default function missionReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case 'REQUEST_INSERT_MISSION_FULFILLED':
      ...
      case 'REQUEST_UPDATE_MISSION_PENDING': {
        return {
          ...state,
          updating: true,
          updated: false,
      ...
      case 'REQUEST_UPDATE_MISSION_FULFILLED': {
        return {
          ...state,
          updating: false,
          updated: true,
